...
function Show-NSXTException() {
    ...
    if ($Exception.Exception.InnerException) {
        ...
        if ("AuthenticationException" -eq $exceptiontype.name) {
            ...
            Write-Warning "Try to use Connect-NSXT -SkipCertificateCheck for connection"
    ...
    If ($Exception.Exception.Response) {
        ...
        Write-Warning "The NSX-T API sends an error message:"
